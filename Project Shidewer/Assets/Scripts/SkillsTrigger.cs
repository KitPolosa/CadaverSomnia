...
public class SkillsTrigger : MonoBehaviour
{
    public GameObject panel;
    public GameObject skillsTrigger;
    public GameObject joystick;
    public GameObject dodge;
    public Joystick StopMove;
    public GameObject SkillsBuyBut;
    ...
    {
        if (other.tag == "SkillsTrigger")
        {
            SkillsBuyBut.SetActive(true);
        }
    }
